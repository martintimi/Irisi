            ...
            <div className="flex items-center gap-2 flex-wrap pt-1">
              {ig && (
                <a
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-gradient-to-br from-[#f09433] via-[#e6683c] to-[#bc1888] text-white text-[10px] font-mono-luxury font-bold uppercase shadow-sm active:scale-95 transition-transform"
                >
              ...
              {tt && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-black border border-white/20 text-white text-[10px] font-mono-luxury font-bold uppercase shadow-sm active:scale-95 transition-transform"
                >
              ...
              {wa && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[#25D366] text-white text-[10px] font-mono-luxury font-bold uppercase shadow-sm active:scale-95 transition-transform"
                >
